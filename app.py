...
# ─────────────────────────────────────────────────────────────────────────────
FEA_GOLD = {
    ("gyroid",    0.1): (1.84,   3.60),   ("gyroid",    0.2): (14.60,  17.00),
    ("gyroid",    0.3): (47.60,  42.00),  ("gyroid",    0.4): (115.0,  84.00),
    ("gyroid",    0.5): (222.0,  144.0),  ("gyroid",    0.6): (398.0,  230.0),
    ("diamond",   0.1): (2.30,   4.20),   ("diamond",   0.2): (16.90,  19.60),
    ("diamond",   0.3): (55.30,  49.00),  ("diamond",   0.4): (133.6,  96.00),
    ("diamond",   0.5): (258.0,  166.0),  ("diamond",   0.6): (460.0,  266.0),
    ("primitive", 0.1): (1.22,   2.40),   ("primitive", 0.2): (9.98,   12.20),
    ("primitive", 0.3): (32.24,  31.00),  ("primitive", 0.4): (78.34,  62.00),
    ("primitive", 0.5): (150.58, 106.0),  ("primitive", 0.6): (270.2,  168.0),
    ("iwp",       0.1): (1.70,   3.30),   ("iwp",       0.2): (13.52,  15.80),
    ("iwp",       0.3): (43.80,  39.00),  ("iwp",       0.4): (106.02, 78.00),
    ("iwp",       0.5): (204.4,  134.0),  ("iwp",       0.6): (365.6,  214.0),
}
