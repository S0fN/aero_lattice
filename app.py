...
# ─────────────────────────────────────────────────────────────────────────────
FEA_GOLD = {
    ("gyroid",    0.1): (0.92,  1.80),   ("gyroid",    0.2): (7.30,  8.50),
    ("gyroid",    0.3): (23.80, 21.00),  ("gyroid",    0.4): (57.50, 42.00),
    ("gyroid",    0.5): (111.0, 72.00),  ("gyroid",    0.6): (199.0, 115.0),
    ("diamond",   0.1): (1.15,  2.10),   ("diamond",   0.2): (8.45,  9.80),
    ("diamond",   0.3): (27.65, 24.50),  ("diamond",   0.4): (66.80, 48.00),
    ("diamond",   0.5): (129.0, 83.00),  ("diamond",   0.6): (230.0, 133.0),
    ("primitive", 0.1): (0.61,  1.20),   ("primitive", 0.2): (4.99,  6.10),
    ("primitive", 0.3): (16.12, 15.50),  ("primitive", 0.4): (39.17, 31.00),
    ("primitive", 0.5): (75.29, 53.00),  ("primitive", 0.6): (135.1, 84.00),
    ("iwp",       0.1): (0.85,  1.65),   ("iwp",       0.2): (6.76,  7.90),
    ("iwp",       0.3): (21.90, 19.50),  ("iwp",       0.4): (53.01, 39.00),
    ("iwp",       0.5): (102.2, 67.00),  ("iwp",       0.6): (182.8, 107.0),
}
