...
# ─────────────────────────────────────────────────────────────────────────────
FEA_GOLD = {
    # (tpms, rho_bucket): (E_eff_GPa, sigma_y_MPa)
    ("gyroid",    0.1): (0.0012, 1.80),  ("gyroid",    0.2): (0.0095, 8.50),
    ("gyroid",    0.3): (0.0310, 21.0),  ("gyroid",    0.4): (0.0750, 42.0),
    ("gyroid",    0.5): (0.1450, 72.0),  ("gyroid",    0.6): (0.2600, 115.0),
    ("diamond",   0.1): (0.0015, 2.10),  ("diamond",   0.2): (0.0110, 9.80),
    ("diamond",   0.3): (0.0360, 24.5),  ("diamond",   0.4): (0.0870, 48.0),
    ("diamond",   0.5): (0.1680, 83.0),  ("diamond",   0.6): (0.3000, 133.0),
    ("primitive", 0.1): (0.0008, 1.20),  ("primitive", 0.2): (0.0065, 6.10),
    ("primitive", 0.3): (0.0210, 15.5),  ("primitive", 0.4): (0.0510, 31.0),
    ("primitive", 0.5): (0.0980, 53.0),  ("primitive", 0.6): (0.1760, 84.0),
    ("iwp",       0.1): (0.0011, 1.65),  ("iwp",       0.2): (0.0088, 7.90),
    ("iwp",       0.3): (0.0285, 19.5),  ("iwp",       0.4): (0.0690, 39.0),
    ("iwp",       0.5): (0.1330, 67.0),  ("iwp",       0.6): (0.2380, 107.0),
}
